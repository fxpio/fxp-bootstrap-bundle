        ...
        $node
            ...
            ->children()
                ...
                ->arrayNode('paths')
                    ...
                    ->prototype('scalar')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/bootstrap/fonts')->end()
                    ->example(array('%kernel.root_dir%/../vendor/bower-asset/bootstrap/fonts', '%kernel.root_dir%/../vendor/foo/bar/fonts'))
                    ->validate()
                        ->ifTrue(function ($v) { return !in_array('%kernel.root_dir%/../vendor/bower-asset/bootstrap/fonts', $v); })
                        ->then(function ($v) {
                            return array_merge(array('%kernel.root_dir%/../vendor/bower-asset/bootstrap/fonts'), $v);
                        })
                    ->end()
                ->end()
            ->end()
        ...
        $node
            ...
            ->children()
                    ...
                    ->children()
                        ->arrayNode('bootstrap')
                            ...
                            ->children()
                                ...
                                ->scalarNode('directory')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/bootstrap/less')->end()
                ...
                ->arrayNode('javascripts')
                    ...
                    ->children()
                        ->arrayNode('jquery')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('path')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/jquery/dist/jquery.js')->end()
                            ->end()
                        ->end()
                        ->arrayNode('bootstrap')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('directory')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/bootstrap/js')->end()
                                ->arrayNode('components')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                ...
                ->arrayNode('hack_lt_ie_9')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('html5_shiv')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/html5shiv/dist/html5shiv.js')->end()
                        ->scalarNode('respond')->defaultValue('%kernel.root_dir%/../vendor/bower-asset/respond/dest/respond.src.js')->end()
                        ->arrayNode('inputs')
                            ->fixXmlConfig('input')
                            ->prototype('scalar')->end()
                            ->defaultValue(array())
