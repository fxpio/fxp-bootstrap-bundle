                    ...
                    ->children()
                        ->arrayNode('bootstrap')
                            ...
                            ->children()
                                ...
                                ->scalarNode('theme')
                                    ->defaultTrue()
                                    ->info('Add your custom theme or activate/disable the default theme')
                                    ->example('"@AcmeDemoBundle/Resources/assetic/less/theme.less" or false')
                                ->end()
                                ->arrayNode('components')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->booleanNode('variables')->defaultTrue()->end()
                                        ->scalarNode('default_variables')->defaultValue('@SonatraBootstrapBundle/Resources/assetic/less/variables.less')->end()
